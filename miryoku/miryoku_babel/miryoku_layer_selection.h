...
#include "miryoku_layer_alternatives.h"
    ...
    #elif defined (MIRYOKU_ALPHAS_NIGHT)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_NIGHT_FLIP
    #elif defined (MIRYOKU_ALPHAS_NIGHTINGALE)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_NIGHTINGALE_FLIP
    ...
    #elif defined (MIRYOKU_ALPHAS_NIGHT)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_NIGHT
    #elif defined (MIRYOKU_ALPHAS_NIGHTINGALE)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_NIGHTINGALE
    #elif defined (MIRYOKU_ALPHAS_GALLIUM)
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_EXTRA_NIGHT)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_NIGHT_FLIP
    #elif defined (MIRYOKU_EXTRA_NIGHTINGALE)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_NIGHTINGALE_FLIP
    ...
    #elif defined (MIRYOKU_EXTRA_NIGHT)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_NIGHT
    #elif defined (MIRYOKU_EXTRA_NIGHTINGALE)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_NIGHTINGALE
    #elif defined (MIRYOKU_EXTRA_GALLIUM)
  ...
  #define MIRYOKU_LAYERMAPPING_EXTRA MIRYOKU_MAPPING
      ...
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_AZERTY_FLIP
    #elif defined (MIRYOKU_TAP_BEAKL15)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_BEAKL15_FLIP
    #elif defined (MIRYOKU_TAP_COLEMAK)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_COLEMAK_FLIP
    #elif defined (MIRYOKU_TAP_COLEMAKDH)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH_FLIP
    #elif defined (MIRYOKU_TAP_COLEMAKDHK)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK_FLIP
    #elif defined (MIRYOKU_TAP_DVORAK)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_DVORAK_FLIP
    #elif defined (MIRYOKU_TAP_HALMAK)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_HALMAK_FLIP
    #elif defined (MIRYOKU_TAP_WORKMAN)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_WORKMAN_FLIP
    #elif defined (MIRYOKU_TAP_QWERTY)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_QWERTY_FLIP
    #elif defined (MIRYOKU_TAP_QWERTZ)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_QWERTZ_FLIP
    #elif defined (MIRYOKU_TAP_NIGHT)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_NIGHT_FLIP
    #elif defined (MIRYOKU_TAP_NIGHTINGALE)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_NIGHTINGALE_FLIP
    #elif defined (MIRYOKU_TAP_GALLIUM)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_GALLIUM_FLIP
    #elif defined (MIRYOKU_TAP_GRAPHITE)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_GRAPHITE_FLIP
    #else
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH_FLIP
    #endif
  #else
    #if defined (MIRYOKU_TAP_AZERTY)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_AZERTY
    #elif defined (MIRYOKU_TAP_BEAKL15)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_BEAKL15
    #elif defined (MIRYOKU_TAP_COLEMAK)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_COLEMAK
    #elif defined (MIRYOKU_TAP_COLEMAKDH)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH
    #elif defined (MIRYOKU_TAP_COLEMAKDHK)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK
    #elif defined (MIRYOKU_TAP_DVORAK)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_DVORAK
    #elif defined (MIRYOKU_TAP_HALMAK)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_HALMAK
    #elif defined (MIRYOKU_TAP_WORKMAN)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_WORKMAN
    #elif defined (MIRYOKU_TAP_QWERTY)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_QWERTY
    #elif defined (MIRYOKU_TAP_QWERTZ)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_QWERTZ
    #elif defined (MIRYOKU_TAP_NIGHT)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_NIGHT
    #elif defined (MIRYOKU_TAP_NIGHTINGALE)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_NIGHTINGALE
    #elif defined (MIRYOKU_TAP_GALLIUM)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_GALLIUM
    #elif defined (MIRYOKU_TAP_GRAPHITE)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_GRAPHITE
    #else
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH
    #endif
  #endif
...
#if !defined(MIRYOKU_LAYER_ALT)
  #if defined (MIRYOKU_LAYERS_FLIP)
    #if defined (MIRYOKU_ALT_AZERTY)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_AZERTY_FLIP
    #elif defined (MIRYOKU_ALT_BEAKL15)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_BEAKL15_FLIP
    #elif defined (MIRYOKU_ALT_COLEMAK)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_COLEMAK_FLIP
    #elif defined (MIRYOKU_ALT_COLEMAKDH)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH_FLIP
    #elif defined (MIRYOKU_ALT_COLEMAKDHK)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK_FLIP
    #elif defined (MIRYOKU_ALT_DVORAK)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_DVORAK_FLIP
    #elif defined (MIRYOKU_ALT_HALMAK)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_HALMAK_FLIP
    #elif defined (MIRYOKU_ALT_WORKMAN)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_WORKMAN_FLIP
    #elif defined (MIRYOKU_ALT_QWERTY)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_QWERTY_FLIP
    #elif defined (MIRYOKU_ALT_QWERTZ)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_QWERTZ_FLIP
    #elif defined (MIRYOKU_ALT_NIGHT)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_NIGHT_FLIP
    #elif defined (MIRYOKU_ALT_NIGHTINGALE)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_NIGHTINGALE_FLIP
    #elif defined (MIRYOKU_ALT_GALLIUM)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_GALLIUM_FLIP
    #elif defined (MIRYOKU_ALT_GRAPHITE)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_GRAPHITE_FLIP
    #else
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_QWERTY_FLIP
    #endif
  #else
    #if defined (MIRYOKU_ALT_AZERTY)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_AZERTY
    #elif defined (MIRYOKU_ALT_BEAKL15)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_BEAKL15
    #elif defined (MIRYOKU_ALT_COLEMAK)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_COLEMAK
    #elif defined (MIRYOKU_ALT_COLEMAKDH)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH
    #elif defined (MIRYOKU_ALT_COLEMAKDHK)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK
    #elif defined (MIRYOKU_ALT_DVORAK)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_DVORAK
    #elif defined (MIRYOKU_ALT_HALMAK)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_HALMAK
    #elif defined (MIRYOKU_ALT_WORKMAN)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_WORKMAN
    #elif defined (MIRYOKU_ALT_QWERTY)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_QWERTY
    #elif defined (MIRYOKU_ALT_QWERTZ)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_QWERTZ
    #elif defined (MIRYOKU_ALT_NIGHT)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_NIGHT
    #elif defined (MIRYOKU_ALT_NIGHTINGALE)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_NIGHTINGALE
    #elif defined (MIRYOKU_ALT_GALLIUM)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_GALLIUM
    #elif defined (MIRYOKU_ALT_GRAPHITE)
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_GRAPHITE
    #else
      #define MIRYOKU_LAYER_ALT MIRYOKU_ALTERNATIVES_BASE_QWERTY
    #endif
  #endif
#endif
#if !defined(MIRYOKU_LAYERMAPPING_ALT)
